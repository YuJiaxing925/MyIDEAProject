...
public class User {
    ...
    public User(int u_id, String u_userName, String u_password, String u_imgUrl, Date u_createTime, Date u_updateTime, int u_role) {
        this.u_id = u_id;
    ...
    public User(int u_id, String u_userName, String u_password, String u_imgUrl, Date u_createTime) {
        this.u_id = u_id;
        this.u_userName = u_userName;
        this.u_password = u_password;
        this.u_imgUrl = u_imgUrl;
    ...
    public User(String u_userName, String u_password, String u_imgUrl, Date u_createTime) {
        this.u_userName = u_userName;
        this.u_password = u_password;
        this.u_imgUrl = u_imgUrl;
        this.u_createTime = u_createTime;
